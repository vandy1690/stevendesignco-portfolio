import{t as e}from"./rolldown-runtime-Dh6celcD.js";var t;function n(){return(n=e((()=>{t=`<div class="page" id="page">
    <!-- Begin .header -->
<header class="header cf" role="banner">
	...
	<ul class="nav-list">
		...
		<li><a href="#">Cultivated</a></li>
	</ul>
</nav><!--end .nav-->
</header>
<!-- End .header -->
    <div role="main">
        	    	    <div class="hp-firstcol">
    ...
    <div class="l-sidebar">
                <ul>
        	<li class="othernavlinks"><a href="#">Login</a> / <a href="#">Register</a></li>
        	<li class="othernavlinks"><a href="#">Digital Magazine</a></li>
        	<li class="othernavlinks"><a href="#">Advertising Opportunities</a></li>
        </ul>
...
<footer class="footer" role="contentinfo">
	<div class="lc">
		<p class="copyright">&copy; 2020 MTG Media group. All rights reserved.</p>
	</div>
</footer>
<!-- End Footer --></div>`})))()}var r;function i(){return(i=e((()=>{r=`<div class="page" id="page">
    <!-- Begin .header -->
<header class="header cf" role="banner">
	<div class="masthead">
		<a href="#"><img src="images/altMeat_logo.svg" class="logo" alt="Logo Alt Text" /></a>		<div class="ad banner"><img src="images/banner_728x90.jpg" alt="728x90 ad" /></div>	</div>
...
<!-- End .header -->
	...
	Emergency! This is a variation of the core homepage template.
</div>	    	    <div class="hp-firstcol">
	    	        <div class="block block-hero">
	<a href="#" class="b-inner">
		<div class="b-thumb">
			<img src="images/fpo_4x3.png" alt="4x3 Image" />		</div>
...
<!-- End Footer --></div>`})))()}var a;function o(){return(o=e((()=>{a=`<div class="page" id="page">
    <!-- Begin .header -->
<header class="header cf" role="banner">
	<div class="masthead">
		<a href="#"><img src="images/altMeat_logo.svg" class="logo" alt="Logo Alt Text" /></a>		<div class="ad banner"><img src="images/banner_728x90.jpg" alt="728x90 ad" /></div>	</div>
...
<!-- End .header -->
    ...
    <article class="article">
        <img src="images/sample/landscape-16x9-mountains.jpg" alt="Mountains" /><p><span class="intro">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</span> Integer fringilla sem a urna porttitor fringilla. Nulla eget justo felis. </p>
...
<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reiciendis, suscipit repellendus nulla accusantium deserunt sed explicabo voluptate sapiente ratione inventore molestiae nihil earum repellat quia odit vitae perspiciatis aliquam amet?</p>
	...
	<fieldset>
		<div class="field-container">
			<!--<label for="comment-email">Subject</label>-->
			<input id="comment-email" type="text" placeholder="Subject headline" />
		</div>
		<div class="field-container">
