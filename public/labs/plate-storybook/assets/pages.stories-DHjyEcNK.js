...
<!-- End .header -->    <div role="main"><div class="block block-hero">
    ...
    <div class="g g-3up">            <div class="gi"><div class="block block-inset">
    <a href="#" class="inner">
...
</div>            </div>            <div class="gi"><div class="block block-inset">
    <a href="#" class="inner">
		<div class="b-thumb"><img src="images/fpo_3x2.png" alt="3x2 Image" /> 
		</div>
		<div class="b-text">
    ...
    <hr/><div class="l-two-col">
    <div class="l-main">    <section class="section latest-posts">
    ...
    <div class="l-sidebar"><section class="section related-posts">
	<h3 class="section-title">Recent Tweets</h3>
	<ul class="headline-list">
		<li><h4><a href="#">Lorem ipsum dolor sit (37 characters)</h4></li>
	</ul>
</section>    </div>
</div>    </div><!--End role=main--><!-- Begin Footer -->
...
<!-- End .header -->    <div role="main"><div class="alert alert-error">Emergency! This is a variation of the core homepage template.
</div><div class="block block-hero">
	<a href="#" class="b-inner">
		<div class="b-thumb"><img src="images/fpo_16x9.png" alt="16x9 Image" /> 
		</div>
		<div class="b-text">
...
<!-- End .header -->    <div role="main"><h1 class="section-title">Our Outdoor Blog</h1>    </div><!--End role=main--><!-- Begin Footer -->
<footer class="footer" role="contentinfo">
	<div class="lc">
		<p class="copyright">&copy; 2013 Company Name. All rights reserved.</p>
	</div>
...
<!-- End .header -->    <div role="main"><div class="l-two-col">
    <div class="l-main">    <article class="article">
        <header class="article-header">
            <h1>Article Headline Lorem ipsum dolor sit aweofij</h1><div class="byline">byAuthorName</div>        </header><p class="intro">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer fringilla sem a urna porttitor fringilla. Nulla eget justo felis. </p>

<p><a href="#">Aliquam erat volutpat.</a> Mauris vulputate scelerisque feugiat. Cras a erat a diam venenatis aliquam. Sed tempus, purus ac pretium varius, risus orci sagittis purus, quis auctor libero magna nec magna. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Maecenas eros dolor, rutrum eu sollicitudin eu, commodo at leo. Suspendisse potenti. Sed eu nibh sit amet quam auctor feugiat vel et risus. Maecenas eu urna adipiscing neque dictum mollis suscipit in augue. Praesent pulvinar condimentum sagittis. Maecenas laoreet neque non eros consectetur fringilla. Donec vitae risus leo, vitae pharetra ipsum. Sed placerat eros eget elit iaculis semper. Aliquam congue blandit orci ac pretium.</p><img src="images/sample/landscape-16x9-mountains.jpg" alt="Mountains" /> 
...
<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reiciendis, suscipit repellendus nulla accusantium deserunt sed explicabo voluptate sapiente ratione inventore molestiae nihil earum repellat quia odit vitae perspiciatis aliquam amet?</p>    </article><!--end .article--><div class="social-share">
...
</div><section class="comments section">
	<div class="comments-container" id="comments-container">
		<h2 class="section-title">59 Comments</h2><form method="post" action="#" class="comment-form">
	<fieldset>
		...
		<ul class="comment-list"><li class="comment-container">
...
</section><section class="section related-posts">
	<h3 class="section-title">Recent Tweets</h3>
	<ul class="headline-list">
		<li><h4><a href="#">Lorem ipsum dolor sit (37 characters)</h4></li>
	</ul>
...
<!-- End Footer --></div>`})))()}var l,u,d,f,p,m;function h(){return(h=e((()=>{n(),i(),o(),c(),l={title:`Pages`},u=()=>t,u.storyName=`Homepage`,d=()=>r,d.storyName=`Homepage Emergency`,f=()=>a,f.storyName=`Blog`,p=()=>s,p.storyName=`Article`,u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`() => html0`,...u.parameters?.docs?.source}}},d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`() => html1`,...d.parameters?.docs?.source}}},f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`() => html2`,...f.parameters?.docs?.source}}},p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`() => html3`,...p.parameters?.docs?.source}}},m=[`Story0`,`Story1`,`Story2`,`Story3`]})))()}h();export{u as Story0,d as Story1,f as Story2,p as Story3,m as __namedExportsOrder,l as default};