...
/* Contrast is computed in the browser against whatever the tokens currently
   resolve to, so these numbers stay true if a token changes. */
const helpers = `
...
DisplayWidths.storyName = 'Display widths';
